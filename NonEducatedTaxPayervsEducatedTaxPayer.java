...
public class NonEducatedTaxPayervsEducatedTaxPayer {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(NonEducatedTaxPayervsEducatedTaxPayer.class);
